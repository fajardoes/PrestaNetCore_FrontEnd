...
export const DailyClosingDashboardPage = () => {
  ...
  return (
    <div className="space-y-4">
      ...
      {statusQuery.error ? (
        <div className="rounded-lg border border-red-200 bg-red-50 p-3 text-xs text-red-700 dark:border-red-500/30 dark:bg-red-500/10 dark:text-red-100">
          {statusQuery.error}
        </div>
      ) : null}
      ...
      {status ? (
        <div className="space-y-2">
          {status.pendingRegisteredPayments > 0 ? (
            <div className="rounded-lg border border-amber-200 bg-amber-50 p-3 text-xs text-amber-800 dark:border-amber-500/30 dark:bg-amber-500/10 dark:text-amber-100">
          ...
          {status.hasCompletedRunForBusinessDate ? (
            <div className="rounded-lg border border-blue-200 bg-blue-50 p-3 text-xs text-blue-800 dark:border-blue-500/30 dark:bg-blue-500/10 dark:text-blue-100">
          ...
          {status.currentRunHeartbeatAt ? (
            <div className="rounded-lg border border-slate-200 bg-white p-3 text-xs text-slate-700 dark:border-slate-800 dark:bg-slate-950 dark:text-slate-200">
          ...
          {status.recoveryRequired ? (
            <div className="rounded-lg border border-red-200 bg-red-50 p-3 text-xs font-medium text-red-800 dark:border-red-500/30 dark:bg-red-500/10 dark:text-red-100">
