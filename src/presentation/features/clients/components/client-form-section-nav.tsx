...
export interface ClientFormSectionNavItem {
  id: string
  title: string
  icon: LucideIcon
}

interface ClientFormSectionNavProps {
  items: ClientFormSectionNavItem[]
  activeSection: string
  onSelect: (sectionId: string) => void
  hasError: (sectionId: string) => boolean
}

export const ClientFormSectionNav = ({
  items,
  activeSection,
  onSelect,
  hasError,
}: ClientFormSectionNavProps) => (
  <nav
