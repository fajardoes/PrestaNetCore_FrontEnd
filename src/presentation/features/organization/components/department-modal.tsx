...
} from '@/infrastructure/validations/organization/department.schema'
        ...
        <div className="mb-4 flex items-start justify-between gap-3">
          <div>
            ...
            <p className="text-sm text-slate-600 dark:text-slate-400">
              Define el nombre, código y slug del departamento. El estado controla si aparece en los listados.
            </p>
          </div>
          <button
            type="button"
          ...
          <div className="flex items-center justify-between rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 text-sm dark:border-slate-800 dark:bg-slate-900">
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400">
                Controla si puede seleccionarse al registrar clientes o municipios.
              </p>
            </div>
