...
const buildPeriodLabel = (result: BalanceSheetResultDto) => {
    ...
    >
      ...
      <View style={styles.totalsRow}>
        <View style={styles.totalCard}>
          ...
          <Text style={styles.totalValue}>{formatAmount(result.totalAssets)}</Text>
        </View>
        <View style={styles.totalCard}>
        ...
        <View style={[styles.totalCard, styles.totalCardLast]}>
          ...
          <Text style={styles.totalValue}>{formatAmount(result.totalEquity)}</Text>
        </View>
      </View>
