...
import type { LoanInsuranceDefinitionResponse } from '@/infrastructure/loans/responses/loan-insurance-response'
            ...
            >
              <div className="space-y-5">
                <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-5">
                  <QueryMetricCard
                    label="Año 1 cobrado"
                    value={formatCurrency(loan.insurance.firstYearInsuranceAmount)}
                    hint="Seguro aplicado al desembolso"
                    accent="blue"
                  />
                  <QueryMetricCard
                    label="Futuro programado"
                    value={formatCurrency(loan.insurance.futureScheduledInsuranceAmount)}
                    hint="Cargos prospectivos desde el segundo año"
                    accent="amber"
                  />
                  <QueryMetricCard
                    label="Cobrado"
                    value={formatCurrency(loan.insurance.collectedInsuranceAmount)}
                    hint="Seguro ya recuperado en cuotas"
                    accent="emerald"
                  />
                  <QueryMetricCard
                    label="Pendiente"
                    value={formatCurrency(loan.insurance.pendingInsuranceAmount)}
                    hint="Seguro aún no cobrado"
                    accent="slate"
                  />
                  <QueryMetricCard
                    label="Cancelado"
                    value={formatCurrency(loan.insurance.cancelledInsuranceAmount)}
                    hint="Seguro futuro dado de baja"
                    accent="slate"
                  />
                </div>

                {!loan.insurance.definitions.length ? (
                  ...
                  <div className="space-y-4">
                    {loan.insurance.definitions.map((definition, index) => (
                      <InsuranceDefinitionCard
